...
pygame.display.set_caption('Snake by dulkin & abdurazakov')
...
main_menu = pygame_menu.Menu('Snake by dulkin & abdurazakov', screen_width, screen_height, theme=pygame_menu.themes.THEME_BLUE)
